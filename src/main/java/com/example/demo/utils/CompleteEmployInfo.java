...
public class CompleteEmployInfo extends Object{
    private int Rec_ID;
    ...
    private int User_ID;//被招聘者userid
    private int accepted;


    public CompleteEmployInfo(int rec_ID, String rec_Salary,String rec_Location, String rec_TimeSchedule, String rec_Title, String rec_Cate, int rec_Enrolled, int rec_Quota, String rec_Desc, String rec_Experience, String rec_Education, int user_ID, int accepted) {
